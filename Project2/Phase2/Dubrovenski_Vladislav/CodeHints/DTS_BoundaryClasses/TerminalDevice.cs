...
namespace DTS_Project
{
    public class TerminalDevice: ITerminalDevice
    {
        ...
        public TerminalDevice(TerminalController terminal)
        {
        ...
        {
            MainMenuDialog mainMenuDialog = new MainMenuDialog(terminal);
            mainMenuDialog.Show();
        }

        public void ShowTenantMenuDialog()
        {
            TenantMenuDialog tenantMenuDialog = new TenantMenuDialog(terminal);
